...
Examples (all options can also be combined with --save out.png):
  python utils_plot_phase.py "test_run\\AB01_4_phase_auto_scale_0.5_input_motor.csv"
  python utils_plot_phase.py "test_run\\AB01_4_phase_auto_scale_0.5_input_motor.csv" --everything
